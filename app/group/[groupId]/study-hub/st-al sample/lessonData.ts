// Stay Alive with Jesus - Lesson Data
// Naming convention: SA01, SA02, etc.

export const stayAliveData: Record<string, any> = {
  "SA01": {
    id: "SA01",
    lessonNumber: 1,
    ...
    sections: [
      ...
      {
        title: "Signs in the Social World",
        content: [
          "Paul wrote: 'In the last days perilous times will come: For men will be lovers of themselves, lovers of money, boastful, proud, blasphemers, disobedient to parents, unthankful, unholy, unloving, unforgiving, slanderers, without self-control, brutal, despisers of good.' (2 Timothy 3:1-3)",
          "Peter also warned: 'Scoffers will come in the last days, walking according to their own lusts, and saying, \"Where is the promise of His coming?\"' (2 Peter 3:3-4)",
          "These social conditions are evident all around us today."
        ],
        scripture: "2 Timothy 3:1-3, 2 Peter 3:3-4"
      },
      {
  ...
  "SA02": {
    ...
    sections: [
      {
        ...
        content: [
          "Jesus comes with power and glory: 'Our God shall come, and shall not keep silent; a fire shall devour before Him, and it shall be very tempestuous all around Him.' (Psalm 50:3)",
          "'For as the lightning comes from the east and flashes to the west, so also will the coming of the Son of Man be.' (Matthew 24:27)",
          "He will come with all the angels: 'When the Son of Man comes in His glory, and all the holy angels with Him, then He will sit on the throne of His glory.' (Matthew 25:31)"
        ],
      ...
      {
        title: "What Happens to Christians Alive",
        content: [
      ...
      {
        title: "What Happens to Christians Who Died",
        content: [
          "The righteous dead will be resurrected: 'The dead in Christ will rise first.'",
          "They will receive new bodies: 'We eagerly wait for the Savior, the Lord Jesus Christ, who will transform our lowly body that it may be conformed to His glorious body.' (Philippians 3:20-21)",
          "Death will be swallowed up in victory! (1 Corinthians 15:54)"
        ],
        scripture: "Philippians 3:20-21, 1 Corinthians 15:54"
      },
      {
        title: "What Happens to the Wicked",
        content: [
          "Those who do not love Christ will not want to see Him: 'The kings of the earth, the great men, the rich men, the commanders, the mighty men, every slave and every free man, hid themselves in the caves and in the rocks of the mountains, and said to the mountains and rocks, \"Fall on us and hide us from the face of Him who sits on the throne and from the wrath of the Lamb!\"' (Revelation 6:15-16)",
    ...
    reflectionQuestions: [
      "How will Jesus return? (Compare with His first coming)",
  ...
  "SA03": {
    ...
    sections: [
      ...
      {
        title: "During the 1000 Years",
        content: [
          "What will the earth be like? 'I beheld the earth, and indeed it was without form, and void; and the heavens, they had no light.' (Jeremiah 4:23)",
          "The earth is described as a 'bottomless pit' or 'abyss.' (Revelation 20:3)",
          "The destruction from Christ's coming has left the earth in a state of desolation, awaiting re-creation."
        ],
        scripture: "Jeremiah 4:23, Revelation 20:3"
      },
      {
    ...
    keyWords: [
      ...
      { word: "Judgment", definition: "The saints' examination of God's justice during the millennium" }
    ],
    application: [
  ...
  "SA04": {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          "Isaiah describes: 'The wilderness and the wasteland shall be glad for them, and the desert shall rejoice and blossom as the rose... The parched ground shall become a pool, and the thirsty land springs of water.' (Isaiah 35:1-2,7)",
          "Even animals will have new natures: 'The wolf also shall dwell with the lamb, the leopard shall lie down with the young goat... They shall not hurt nor destroy in all My holy mountain.' (Isaiah 11:6-9)",
      ...
      },
      {
        ...
        content: [
          "You'll build and plant: 'They shall build houses and inhabit them; they shall plant vineyards and eat their fruit... My elect shall long enjoy the work of their hands.' (Isaiah 65:21-22)",
      ...
      },
      {
        ...
        content: [
          ...
          "You'll never get sick or old or die. (Revelation 21:4; Isaiah 33:24)"
        ],
        scripture: "1 John 3:2, Revelation 21:4, Isaiah 33:24"
      },
      {
        title: "Who Will Be There?",
        content: [
          "Only those who love Jesus: 'There shall by no means enter it anything that defiles, or causes an abomination or a lie, but only those who are written in the Lamb's Book of Life.' (Revelation 21:27)",
          "God desires that all be saved: 'I have loved you with an everlasting love.' (Jeremiah 31:3)",
          "Will you be there? God invites you today to accept His gift of eternal life."
        ],
        scripture: "Revelation 21:27, Jeremiah 31:3"
      }
    ],
    ...
    reflectionQuestions: [
      ...
      "Who will be there? Who will not be there?",
  ...
  "SA05": {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          "Solomon wrote: 'The living know that they will die; but the dead know nothing, and they have no more reward... There is no work or device or knowledge or wisdom in the grave where you are going.' (Ecclesiastes 9:5-6,10)",
      ...
      },
      {
        ...
        content: [
          ...
          "From this ancient lie comes many false ideas: 'your spirit lives on,' 'your soul goes to heaven,' 'you'll be reincarnated.' All attempts to contact the dead are based on Satan's lie."
        ],
      ...
      },
      {
        ...
        content: [
          "God warns: 'Should not a people seek their God? Should they seek the dead on behalf of the living? To the law and to the testimony! If they do not speak according to this word, it is because there is no light in them.' (Isaiah 8:19-20)",
          "The dead know nothing. Satan disguises himself as someone from the dead.",
          "This is why God forbids contacting the dead—it opens us to deception."
        ],
  ...
  "SA06": {
    ...
    memoryVerse: "Malachi 4:1 - 'For behold, the day is coming, burning like an oven, and all the proud, yes, all who do wickedly will be stubble. And the day which is coming shall burn them up,' says the Lord of hosts, 'That will leave them neither root nor branch.'",
    sections: [
      {
      ...
      },
      {
        ...
        content: [
          "The destruction of the wicked takes place at the end of the thousand years: 'The devil, who deceived them, was cast into the lake of fire... And anyone not found written in the Book of Life was cast into the lake of fire.' (Revelation 20:10-15)",
      ...
      {
        title: "What About Sodom and Gomorrah?",
        content: [
          "Jude says Sodom and Gomorrah 'are set forth as an example, suffering the vengeance of eternal fire.' (Jude 7)",
          "These cities are not burning today. It is the effects of the fire that are everlasting—not the fire itself.",
          "The fire destroyed them completely—that's the 'eternal' result."
        ],
        scripture: "Jude 7"
      },
      {
        title: "The Final Cleansing",
        content: [
          "After the wicked are destroyed, God will create a new earth: 'We, according to His promise, look for new heavens and a new earth in which righteousness dwells.' (2 Peter 3:13)",
          "God is going to make a sin-free new earth!",
          "Sin will never rise again. (Nahum 1:9)"
        ],
        scripture: "2 Peter 3:13, Nahum 1:9"
      },
      {
    ...
    reflectionQuestions: [
      ...
      "What happened to Sodom and Gomorrah as an example?",
      "How can you be sure to have eternal life?"
    ],
    prayerPrompt: "Lord, thank You for Your love and patience. Thank You that You don't want anyone to perish. Help me to choose life today and to share this good news with others. Give me courage to tell others about Your love. Amen.",
    keyWords: [
