// src/app/group/[groupId]/study-101/handbookData.ts
...
export const handbookData: Record<string, StudyData> = {
  ...
  "1": {
    ...
    reflections: [
      "How would you define the Bible based on this study?",
      "What is true freedom according to Jesus in John 8:31-36?",
      "Why does the son ask for his inheritance? What does this symbolize?"
    ],
  ...
  "2": {
    ...
    reflections: [
      "Is there anything in nature that arouses your admiration?",
      "Have you ever been tempted not to believe? What helped you?",
      "What does Hebrews 11:6 teach about faith and pleasing God?"
    ],
  ...
  "3": {
    ...
    reflections: [
      "Do you feel God's love is dependent on your performance?",
      "How does knowing God cares for sparrows help your anxiety?",
      "What does it mean that God loved us 'while we were still sinners'?"
    ],
  ...
  "4": {
    ...
    sections: [
      ...
      { t: "God's Grace in Christ", c: "It was by God's grace that we can see Jesus as He truly is—God revealed in human flesh. (John 1:1-3; Colossians 2:9)" }
    ],
    reflections: [
      "What difference does it make that Jesus is the Son of God?",
      "Can we see Jesus' true divine essence beyond His human appearance?",
  ...
  "5": {
    ...
    reflections: [
      "How have you felt the Spirit's guidance in your life?",
      "Why is it important that the Spirit is a person and not just a force?",
  ...
  "6": {
    ...
    reflections: [
      ...
      "What is the purpose of Scripture in your daily life?",
      "How did the Bereans study the Scriptures?"
    ],
  ...
  "7": {
    ...
    reflections: [
      "How can we sustain our faith in the Creator in today's culture?",
      "Why does the Bible emphasize 'it was good'?",
      "What hope does creation give us for the future?"
    ],
  ...
  "8": {
    ...
    reflections: [
      "Why did God allow the possibility of evil?",
      "How does the cross answer the problem of suffering?",
      "What does 1 John 1:5 teach us about God's character?"
    ],
  ...
  "9": {
    ...
    reflections: [
      "How do ancient prophecies build your faith in Jesus today?",
      "What does 'the fullness of time' mean to you?",
      "Why did God use a 'seed' as a symbol of the Savior?"
    ],
  ...
  "10": {
    ...
    reflections: [
      "Can we think of 'paying' for Jesus' sacrifice?",
      "What does it mean to you that Jesus is your Advocate?",
  ...
  "11": {
    ...
    sections: [
      { t: "The Despised Savior", c: "The Savior was despised and rejected, a man of sorrows, acquainted with grief. He was despised, and we esteemed Him not. (Isaiah 53:2-3)" },
    ...
    reflections: [
      "How would you have reacted to Jesus' cross?",
      "Why did God choose to save us through suffering?",
      "What does Isaiah 53 teach us about God's character?"
    ],
  ...
  "12": {
    ...
    reflections: [
      "Why is the divinity of Jesus essential to our salvation?",
      "What does 'God with us' mean in your daily struggles?",
  ...
  "13": {
    ...
    reflections: [
      "How does the promise of the Second Coming change your perspective on death?",
      "Are you living in readiness for His appearing?",
  ...
  "14": {
    ...
    reflections: [
      "How can we balance watching for signs while not predicting dates?",
  ...
  "15": {
    ...
    reflections: [
      ...
      "What is the purpose of the saints judging the world?"
    ],
  ...
  "16": {
    ...
    reflections: [
      ...
      "How does this hope affect your life today?"
    ],
  ...
  "17": {
    ...
    reflections: [
      "How does the law show God's character?",
      "What is the difference between legalism and loving obedience?",
      "How can we keep the law without being legalistic?"
    ],
  ...
  "18": {
    ...
    reflections: [
      "How does the Sabbath connect us to creation?",
  ...
  "19": {
    ...
    reflections: [
      "How does the sanctuary help us understand salvation?",
      "What does Jesus' work as our High Priest mean for you today?"
    ],
  ...
  "20": {
    ...
    reflections: [
      "Why is it important that salvation is a gift?",
      "What is the relationship between faith and works?",
      "How does assurance of salvation affect your daily life?"
    ],
  ...
  "22": {
    ...
    reflections: [
      "What does baptism represent in your spiritual journey?",
  ...
  "23": {
    ...
    reflections: [
      "What spiritual gifts do you see in your life?",
  ...
  "24": {
    ...
    reflections: [
      ...
      "What obstacles keep you from praying regularly?"
    ],
  ...
  "25": {
    ...
    reflections: [
      ...
      "How does this service draw you closer to Jesus?"
    ],
  ...
  "26": {
    ...
    reflections: [
      "How can you be a better steward of God's gifts?",
      "What does generous giving look like in your life?"
    ],
  ...
  "27": {
    ...
    reflections: [
      "What principles from Scripture can strengthen your marriage?",
      "How can parents effectively pass faith to their children?"
    ],
  ...
  "28": {
    ...
    reflections: [
      "How does the biblical teaching on death give you comfort?",
  ...
  "29": {
    ...
    reflections: [
      "How does the great controversy help explain suffering?",
      "What is your role in God's victory over evil?"
    ],
  ...
  "30": {
    ...
    reflections: [
      "What does it mean to be part of God's remnant people?",
      "How can you share the three angels' messages in love?"
    ],
  ...
  "31": {
    ...
    reflections: [
      ...
      "How does the Sabbath connect to worship of the Creator?"
    ],
  ...
  "32": {
    ...
    reflections: [
      ...
      "How can we stay faithful when many around us compromise?"
    ],
  ...
  "33": {
    ...
    reflections: [
      "What areas of your life need God's transforming power?",
  ...
  "34": {
    ...
    reflections: [
      "What does it mean to 'put on Christ' daily?",
  ...
  "35": {
    ...
    reflections: [
      "How can you ensure your faith is producing good fruit?",
  ...
  "36": {
    ...
    reflections: [
      "How have trials strengthened your faith?",
      "How can you comfort others going through difficulties?"
    ],
  ...
  "37": {
    ...
    reflections: [
      "How does this prophecy strengthen your confidence in God's Word?",
      "What does the cleansing of the sanctuary mean for you today?"
    ],
  ...
  "38": {
    ...
    reflections: [
      ...
      "Why is it important to understand prophecy?"
    ],
  ...
  "39": {
    ...
    reflections: [
      ...
      "How can we prepare for challenges to religious liberty?"
    ],
  ...
  "40": {
    ...
    reflections: [
      "How can you share these messages with love and grace?",
      "What does it mean to worship the Creator today?"
    ],
  ...
  "41": {
    ...
    reflections: [
      "How does the judgment give you confidence in God's justice?",
      "What does Jesus' work as our Advocate mean to you?"
    ],
  ...
  "42": {
    ...
    reflections: [
      "How can you prepare for the day of the Lord?",
      "What does it mean that God's people have nothing to fear?"
    ],
  ...
  "43": {
    ...
    reflections: [
      "What aspect of heaven are you most excited about?",
      "How does the hope of heaven affect your daily choices?"
    ],
  ...
  "44": {
    ...
    reflections: [
      "How can you worship God in your daily life?",
  ...
  "45": {
    ...
    reflections: [
      "How can you prepare to receive the latter rain?",
      "What would happen if the church experienced a Pentecost today?"
    ],
  ...
  "46": {
    ...
    reflections: [
      "How can you better care for your body as God's temple?",
      "What lifestyle changes might improve your health?"
    ],
  ...
  "47": {
    ...
    reflections: [
      "How does knowing about angels affect your daily life?",
      "What comfort does angelic protection bring?"
    ],
  ...
  "49": {
    ...
    reflections: [
      "How does the Trinity reveal God's relational nature?",
      "How does each person of the Godhead relate to you?"
    ],
  ...
  "50": {
    ...
    reflections: [
      "How does Christian hope differ from worldly optimism?",
      "How can hope sustain you through difficult times?"
    ],
